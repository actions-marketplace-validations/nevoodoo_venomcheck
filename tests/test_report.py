"""Tests for venomcheck.report — markdown report generation."""

from __future__ import annotations

from venomcheck.graph import DependencyGraph, PackageInfo
from venomcheck.osv import Vulnerability
from venomcheck.report import Finding, build_findings, generate_markdown
