"""Tests for venomcheck.cli — end-to-end wiring."""
...
from venomcheck.cli import main
from venomcheck.osv import OsvResults, Vulnerability
...
class TestCli:
    @patch("venomcheck.cli.query_osv", side_effect=_mock_osv_no_vulns)
    ...
    @patch("venomcheck.cli.query_osv", side_effect=_mock_osv_with_vulns)
    ...
    @patch("venomcheck.cli.query_osv")
    def test_osv_errors_warned(self, mock_osv, capsys):
        from venomcheck.osv import OsvResults
